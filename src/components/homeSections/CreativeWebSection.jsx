      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-4">
            ...
            <img
              ...
              alt="Creative work 2"
              className="rounded-2xl shadow-lg w-38 md:w-60 lg:w-full h-40 object-cover max-w-full"
            />
          </div>
          <img
        ...
        <div className="mt-6 lg:mt-0">
          ...
          <p className="text-gray-700 text-sm sm:text-base mb-4">
           We’re a web development company in Kerala that builds conversion-ready websites for businesses across industries</p>

          <p className="text-gray-700 text-sm sm:text-base mb-4">
           We’re not some big agency with a team of 50 and a minimum billing of ₹80K
            From <span className="underline font-medium">Project-based work</span> and
            <span className="underline font-medium"> Monthly retainers
</span> to branding,
            <span className="underline font-medium"> Freelancer-level flexibility</span>,
            <span className="underline font-medium"> Agency-level output
</span> and UI/UX,
            we take care of every detail to create a solution that’s tailored just for you.
          </p>

          <p className="text-gray-700 text-sm sm:text-base mb-4 sm:mb-6">
           From clean one-pagers to fully functional business websites, we build platforms that are fast, responsive, and tailored to your brand
          </p>
